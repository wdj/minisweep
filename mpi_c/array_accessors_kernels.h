 ...
 * \brief  array_accessors code for device kernels.
 * \note   Copyright (C) 2014 Oak Ridge National Laboratory, UT-Battelle, LLC.
 */
/*---------------------------------------------------------------------------*/

#ifndef _serial_c__array_accessors_kernels_h_
#define _serial_c__array_accessors_kernels_h_
...
#endif /*---_serial_c__array_accessors_kernels_h_---*/
