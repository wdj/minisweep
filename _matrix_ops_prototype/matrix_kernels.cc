/*---------------------------------------------------------------------------*/
/*!
 * \file   matrix_kernels.cc
 * \author Wayne Joubert
 * \date   Mon Jul 27 11:38:40 EDT 2015
 * \brief  Sequence of matrix operation kernels resembling full sweep code.
...
The following kernels each perform two repeated matrix-vector products
within loops.  The code is written in multiple ways to illustrate the
impacts on performance of how the code is written.
...
//=============================================================================
//---5. Convert SX array to registers (depending on compiler behavior).
...
//=============================================================================
//---6. Replicate iM loop, to move if-test outside loop.
//---   Replace iA with 0 when possible.
...
int main( int argc, char** argv )
{
  ...
  //---Run once to touch memory - place pages and hopefully improve performance.

  sub1( v, w, matrix1, matrix2, sX, nE, nU, nM, nA );


  //---Run, time the different cases.
