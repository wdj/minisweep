...
static void Env_mpi_nullify_values_( Env *env )
{
#ifdef USE_MPI
...
static Bool_t Env_mpi_are_values_set_( const Env *env )
{
...
static void Env_mpi_finalize_values_( Env* env )
{
#ifdef USE_MPI
...
static double Env_sum_d( Env* env, double value )
{
  Assert( Env_mpi_are_values_set_( env ) );
  double result = 0;
#ifdef USE_MPI
...
static P Env_sum_P( Env* env, P value )
{
  Assert( Env_mpi_are_values_set_( env ) );
...
static void Env_send_i( Env* env, const int* data, size_t n, int proc, int tag )
{
  Assert( Env_mpi_are_values_set_( env ) );
  Assert( data != NULL );
  Assert( n+1 >= 1 );
...
static void Env_recv_i( Env* env, int* data, size_t n, int proc, int tag )
{
  Assert( Env_mpi_are_values_set_( env ) );
  Assert( data != NULL );
  Assert( n+1 >= 1 );
...
static void Env_send_P( Env* env, const P* data, size_t n, int proc, int tag )
{
  Assert( Env_mpi_are_values_set_( env ) );
  Static_Assert( P_IS_DOUBLE );
  Assert( data != NULL );
...
static void Env_recv_P( Env* env, P* data, size_t n, int proc, int tag )
{
  Assert( Env_mpi_are_values_set_( env ) );
  Static_Assert( P_IS_DOUBLE );
  Assert( data != NULL );
...
static void Env_asend_P( Env* env, const P* data, size_t n, int proc, int tag,
                                                          Request_t* request )
{
  Assert( Env_mpi_are_values_set_( env ) );
  Static_Assert( P_IS_DOUBLE );
...
static void Env_arecv_P( Env* env, const P* data, size_t n, int proc, int tag,
                                                          Request_t* request )
{
  Assert( Env_mpi_are_values_set_( env ) );
  Static_Assert( P_IS_DOUBLE );
...
static void Env_wait( Env* env, Request_t* request )
{
#ifdef USE_MPI
  MPI_Status status;
